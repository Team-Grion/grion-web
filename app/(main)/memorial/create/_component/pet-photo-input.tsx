  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <button
        ...
        className="border-muted-foreground/40 bg-background hover:bg-background/70 relative flex size-28 shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-full border-2 border-dashed transition-colors"
      >
        {previewUrl ? (
